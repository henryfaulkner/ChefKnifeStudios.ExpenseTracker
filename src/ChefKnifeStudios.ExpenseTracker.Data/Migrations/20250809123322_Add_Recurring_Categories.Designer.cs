...
namespace ChefKnifeStudios.ExpenseTracker.Data.Migrations
{
    ...
    [Migration("20250809123322_Add_Recurring_Categories")]
    partial class Add_Recurring_Categories
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ChefKnifeStudios.ExpenseTracker.Data.Models.Category", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("Categories", "ExpenseTracker");
                });

            modelBuilder.Entity("ChefKnifeStudios.ExpenseTracker.Data.Models.CategorySemantic", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("CategorySemantics", "ExpenseTracker");
                });
            ...
            modelBuilder.Entity("ChefKnifeStudios.ExpenseTracker.Data.Models.ExpenseCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("ExpenseId", "CategoryId")
                        .IsUnique();

                    b.ToTable("ExpenseCategories", "ExpenseTracker");
                });
            ...
            modelBuilder.Entity("ChefKnifeStudios.ExpenseTracker.Data.Models.CategorySemantic", b =>
                {
                    b.HasOne("ChefKnifeStudios.ExpenseTracker.Data.Models.Category", "Category")
                        .WithOne("CategorySemantic")
                        .HasForeignKey("ChefKnifeStudios.ExpenseTracker.Data.Models.CategorySemantic", "CategoryId")
